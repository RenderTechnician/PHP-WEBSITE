...
<div id="add">
	...
	if (isset($_POST['Name']) && isset($_POST['Email']) && isset($_POST['SID']) && isset($_POST['Faculty'])) 
	{
		...
		$postvalidvalues = array(	'Faculty of Arts, Law and Social Sciences',
								 	'Lord Ashcroft International Business School ',
									'Faculty of Health, Social Care & Education',
									'Faculty of Science and Technology',
									'Faculty of Medical Science');

		if (in_array($_POST['Faculty'], $postvalidvalues)) 
		{
		...
		} else {echo "<br>Faculty value invalid. If this problem persists please contact the administrator";}
		//execute the query
	}?>
</div>
</body>
